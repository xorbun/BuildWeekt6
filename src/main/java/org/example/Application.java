...
public class Application {
        ...
        public static void main(String[] args) {
                ...
                // 1 ----------------GENERO BIGLIETTI DOPO AVERE CARICATO SU DB DEI
                // RIVENDITORI----------------
                ...
                // 2 ----------------GENERO ABBONAMENTI DOPO AVERE CARICATO SU DB DEGLI
                // UTENTI----------------
                ...
                // 4 ----------------CERCA BIGLIETTI PER ANNO E PER PUNTO
                // EMISSIONE----------------
                ...
                // 6 ----------------MANDA IN MANUTENZIONE O IN SERVIZIO UN
                // MEZZO----------------

                // -------------------Genero una istanza di riparazione e la associo ad un
                // mezzo-----------------
                ...
                // --------------ricerco storico manutenzioni per un
                // mezzo------------------------
                ...
                // TICKET-------------------------------
                System.out.println(
                                "-----------------------------VIDIMAZIONE DEI TICKET-------------------------------");
                bd.timbraticket(bus, bigliettofromDB);

                // 8------------------------------RICERCA BIGLIETTI TIMBRATI SU UN MEZZO O IN
                // TOTALE-----------------------------
                System.out.println(
                                "--------------------RICERCA BIGLIETTI TIMBRATI SU UN MEZZO O IN TOTALE--------------------------");
                ...
                System.out.println(
                                "-------------CERCO NUMERO DI VOLTE CHE UN MEZZO HA PERCORSO UNA TRATTA SPECIFICA--------------");
                ttd.counterpercorrenze(bus, milanoNapoliFromdb);

                System.out.println(
                                "--------------CERCO I TEMPI EFFETTIVI DI OGNI CORSA PRESENTE NEL DB---------------------------");
