            ...
            if (existingAbb == null) {
                if (user != null && rivenditore != null) {
                    ...
                    if (user.getNumerotessera() == null) {
                        ...
                        System.out.println("L'utente con id: " + user.getId()
                                + " risulta sprovvisto di tessera, desideri crearne una?");
                        ...
                        switch (option) {
                            case 1: {
                                ...
                                System.out.println(
                                        "Che tipo di abbonamento vuoi creare? Premi 1 per settimanale o 2 per mensile");
